...
<style type="text/css">
    .theme-mix2{
        ...
        background: -webkit-linear-gradient(to bottom, #00F260, #0072ff) !important; /* Chrome 10-25, Safari 5.1-6 */
        background: linear-gradient(to bottom, #00F260, #0072ff)  !important; /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    }
</style>
@section('content')
                ...
                <div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
                    <div class="uk-width-1-1@m">
                        <div class="uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <h3 class="uk-card-title uk-text-center" style="color: #00F260">Betwas Administrador</h3>
